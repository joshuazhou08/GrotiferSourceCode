...
//
//  Discussion:
//      *** Modified by DM Auslander, 5/22/23, to add "double val[]" to argument list for fn.
//      This allows for the passing of auxiliary information to the evaluation function.
//      "val[]" itself is added at the end of the argument list. ***
//
...
//  Parameters:
//
//    Input, double FN ( double x[], double val[] ), the name of the routine which evaluates
